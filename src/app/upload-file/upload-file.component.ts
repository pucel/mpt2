...
import * as fromFileUploadActions from '../upload-file/upload-file-store/actions';
import * as fromFileUploadSelectors from '../upload-file/upload-file-store/selectors';
import * as fromFileUploadState from '../upload-file/upload-file-store/state';
